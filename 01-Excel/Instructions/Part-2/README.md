# Part 2: Excel Homework: Kickstart My Chart
...
1. Create a new space for this project called `excel-challenge` in your homework folder. **Do not add this homework to an existing space**.
