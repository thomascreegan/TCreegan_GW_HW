...
file_to_load = os.path.join(r"C:\Users\tommy\Documents\GWU-ARL-DATA-PT-09-2019-U-C\02-Homework\03-Python\Instructions\Part-3\PyBoss\employee_data.csv")
file_to_output = os.path.join(r"C:\Users\tommy\Documents\GWU-ARL-DATA-PT-09-2019-U-C\02-Homework\03-Python\Instructions\Part-3\PyBoss\employee_data_reformatted.csv")
