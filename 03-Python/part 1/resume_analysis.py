...
# Paths
resume_path = os.path.join(r"C:\Users\tommy\Documents\GWU-ARL-DATA-PT-09-2019-U-C\02-Homework\03-Python\Instructions\Part-1\HW_Task4_ResumeAnalysis\Resources\resume.md")
...
# Clean Punctuation
_word_count = s.translate(None, string.punctuation)
